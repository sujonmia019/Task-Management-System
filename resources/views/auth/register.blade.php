                ...
                <div class="card-body text-center p-4">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="row g-3 justify-content-center">
                            <div class="col-md-12">
                                <input type="text" name="name" value="{{ old('name') }}" required class="form-control form-control-sm rounded-0 shadow-none" id="name" placeholder="Enter Name">
                                @error('name')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <input type="email" name="email" value="{{ old('email') }}" required class="form-control form-control-sm rounded-0 shadow-none" id="email" placeholder="Enter Email">
                                @error('email')
                                    <small class="d-block text-danger text-start">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                <input type="password" name="password_confirmation" required class="form-control form-control-sm rounded-0 shadow-none" id="password_confirmation" placeholder="Confirm Password">
